...
from projeto.views.ProdutoView import list_produto_view, edit_produto_view, edit_produto_postback, details_produto_view, delete_produto_view
...
urlpatterns = [
    ...
    path("edit/<int:id>", edit_produto_postback, name= 'edit_produto_postback'),
